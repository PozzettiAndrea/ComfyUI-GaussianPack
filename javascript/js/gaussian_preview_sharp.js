...
console.log("[GaussianPack Sharp] Loading extension...");

app.registerExtension({
    name: "gaussianpack.previewgaussiansharp",

    async beforeRegisterNodeDef(nodeType, nodeData, app) {
        if (nodeData.name === "PreviewGaussianSharp") {
            console.log("[GaussianPack Sharp] Registering Preview Gaussian Sharp node");
